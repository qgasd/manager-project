...
export class InterfaceService {
  ...
  public interfaceurlst= this.ipurl+"/interface/searchstate";
   ...
   * 新增、搜索、删除后查询数据
   */
  public searcshState():Observable<ofInterface[]>{
    return this.http.get(this.interfaceurlst).map(
      res=>{
        let result = res.json();
        console.log(result)      
        return result;
